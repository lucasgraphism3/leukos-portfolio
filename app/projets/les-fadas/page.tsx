          ...
          <div className="projet__container">
            ...
            <div className="projet__infos">
              <div className="projet__logo">
                <img src="/projects/les-fadas/logo.webp" alt="Les Fadas logo" />
              </div>
            ...
            <div className="projet__gallery">
              <img src="/projects/les-fadas/1.jpg" alt="Les Fadas" className="projet__galleryImgSquare" />
              <img src="/projects/les-fadas/2.jpg" alt="Les Fadas" className="projet__galleryImgWide" />
              <img src="/projects/les-fadas/3.jpg" alt="Les Fadas" className="projet__galleryImgSquare" />
              <img src="/projects/les-fadas/4.jpg" alt="Les Fadas" className="projet__galleryImgWide" />
              <img src="/projects/les-fadas/5.jpg" alt="Les Fadas" className="projet__galleryImgSquare" />
              <img src="/projects/les-fadas/6.jpg" alt="Les Fadas" className="projet__galleryImgSquare" />
            </div>
