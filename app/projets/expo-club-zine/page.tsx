          ...
          <div className="projet__container">
            ...
            <div className="projet__infos">
              <div className="projet__logo">
                <img src="/projects/expo-club-zine/logo.webp" alt="Expo Club Zine logo" />
              </div>
            ...
            <div className="projet__gallery">
              <img src="/projects/expo-club-zine/1.jpg" alt="Expo Club Zine" className="projet__galleryImgSquare" />
              <img src="/projects/expo-club-zine/2.jpg" alt="Expo Club Zine" className="projet__galleryImgWide" />
              <img src="/projects/expo-club-zine/3.jpg" alt="Expo Club Zine" className="projet__galleryImgSquare" />
              <img src="/projects/expo-club-zine/4.jpg" alt="Expo Club Zine" className="projet__galleryImgWide" />
              <img src="/projects/expo-club-zine/5.jpg" alt="Expo Club Zine" className="projet__galleryImgSquare" />
              <img src="/projects/expo-club-zine/6.jpg" alt="Expo Club Zine" className="projet__galleryImgWide" />
            </div>
